...
// File        : gp_aes_core.sv
// Description : AES core. Connects datapath and key expansion modules.
...
input logic                                             clk_i;
input logic                                             reset_nai;
input logic                                             dir_i;
input logic                                             a_valid_i;
input logic                                             key_valid_i;
input logic                                             b_req_i;
input logic  [3:0][3:0][7:0]                            a_i;
input logic  [7:0][3:0][7:0]                            key_i;
input logic  [3:0]                                      nr_i;
input logic  [3:0]                                      nk_i;
input logic                                             clear_i;

output logic [3:0][3:0][7:0]                            b_o;
output logic                                            b_valid_o;
output logic                                            a_req_o;
output logic                                            key_req_o;
output logic                                            fault_o;

logic                                                   dp_en;
logic [3:0]                                             round_dp;
logic [3:0][3:0][7:0]                                   rkeyo;
logic [3:0][3:0][7:0]                                   rkeyi;
logic                                                   error_dp;
logic                                                   error_kexp;
logic                                                   clear;
logic                                                   last_round;
