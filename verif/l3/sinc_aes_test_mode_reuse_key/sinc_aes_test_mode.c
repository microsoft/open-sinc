...
// Description   : C test that runs AES test mode reusing the same key across operations
...
uint32_t key_arr[8] = {0x5a5e69ae, 0x0e7ba9ba, 0x9b518b97, 0x790fbd3b, 0x756699b7, 0xcb033879, 0x677edae1, 0xe3715dc0};
uint32_t pt_arr[4] = {0xb5ff6886 ,0x11b58739 ,0xc75331df ,0xe9dda8b9};
uint32_t ct_arr[4] = {0xa8bdff8e ,0x17a57a16 ,0xe7cae82f ,0x00f77d9a};

uint32_t pt_arr2[8] = {0xd032ff6a ,0x9dcfa192 ,0x8eccb290 ,0x3e8e8752 ,0xa63dc851 ,0xda40faa8 ,0xbf03b0be ,0x1152e9c6};
uint32_t ct_arr2[8] = {0x44e0b577 ,0x2605dfd4 ,0x43dd82d9 ,0xcc03f518 ,0x6c801fb7 ,0xf2fed142 ,0x03875472 ,0x5c0868cb};
...
VOID RUN_TEST(UINT32 iteration) {
  ...
  wordcpy(aes_data.ciphertext,ct_arr2,4*num_blocks);
